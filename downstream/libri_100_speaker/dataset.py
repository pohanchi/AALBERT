...
class DownstreamDataset(Dataset):
    ...
    def prepare_data(self):
        ...
        for index in range(len(self.root_key)):
            ...
            cache_path = f'./downstream/libri_100_speaker/pretrained_cache/{self.root_key[index]}.p' 
...
class DataModule(LightningDataModule):
    def __init__(self, data_config, meta_data, max_timestep=None):
        super().__init__()
    ...
    def prepare_data(self):
        ...
        DownstreamDataset(**dataset_config)
    ...
    def setup(self, stage=None):        
        ...
        if stage == "test":
            dataset_config = {"data_config": self.datarc, "meta_data": self.meta_data}
            self.dataset_full = DownstreamDataset(**dataset_config)
            self.dataset_train = self.dataset_full            
